class Stopwatch {
    ...
    results() {
    	let wynik = this.display.innerText = this.format(this.times);
    	let rezultaty = document.querySelector('.results');
...
saveButton.addEventListener('click', () => stopwatch.results());
